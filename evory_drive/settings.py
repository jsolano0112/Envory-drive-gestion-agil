"""
Django settings for evory_drive project.
...
WSGI_APPLICATION = 'evory_drive.wsgi.application'
...
# ====================================
LOGIN_URL = '/'  # Redirige al inicio si no está autenticado
